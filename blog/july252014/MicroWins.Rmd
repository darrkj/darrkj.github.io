...
I wrote some code to implement this methodology. There seems to be a few versions out there but I really like to see how things work and the best way I have found to do this is to create them myself. You can find a copy of this code [here](https://github.com/darrkj/blob/gh-pages/analysis/MicroWins/R/sax.R), which is better documented than the code contained in this post as it is setup to create help files.

You can also run it remotely by executing the following.

```{r, eval = F}
devtools::source_url('https://raw.githubusercontent.com/darrkj/gh-pages/analysis/MicroWins/R/sax.R')
```
...
devtools::source_url('https://raw.githubusercontent.com/darrkj/gh-pages/analysis/MicroWins/R/game.R')
```
